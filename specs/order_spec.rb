...
describe "Order Wave 1" do
  ...
  describe "#remove_product" do
    ...
    it "Raises an ArgumentError if the product isn't present" do
      ...
      expect {
        order.remove_product("drink_that_makes_you_gay")
      }.must_raise ArgumentError
...
describe "Order Wave 2" do
  ...
  describe "Order.find" do
    ...
    it "Returns nil for an order that doesn't exist" do
      bogus_order = Order.find(1337)

      assert_nil(bogus_order)
    end
  end

  describe "Order.find_by_customer" do
    it "Returns an array of order instances matching the first customer ID" do
    ...
    it "Returns an array of order instances matching the last customer ID" do
